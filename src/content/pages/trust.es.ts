...
export const control: typeof En.control = {
  ...
  subtitle:
    "Pengui se instala de tu lado. Tus datos los almacenas, los procesas y los gobiernas tú — nosotros no los guardamos ni los vemos. Tres preguntas que te hará tu equipo de seguridad, respondidas:",
  items: [
    {
      question: "“¿Dónde se ejecuta?”",
      answer:
        "En tu propia nube o en tu propio centro de datos — air-gapped si lo necesitas. Toda la plataforma vive dentro de tu red, y el almacenamiento es tuyo: el cifrado y la rotación de claves siguen tus propias políticas.",
    },
    {
      question: "“¿Qué sale de nuestro entorno?”",
      answer:
        "Solo lo que envías al modelo que elegiste, con tus propias claves. Conecta Pengui a un modelo que alojes tú mismo y la respuesta es: nada.",
    },
    {
  ...
  note: "Sobre las certificaciones, sin vueltas. Las que gobiernan tus datos son las que ya tienes. La plataforma corre en tu entorno y tu información nunca llega a nosotros — así que el perímetro de cumplimiento, y la auditoría, siguen siendo tuyos.",
};
