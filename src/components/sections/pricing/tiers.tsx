  ...
  return (
    <section className="bg-secondary py-20 sm:py-28">
      <Container>
          ...
          {plans.map((tier) => (
            <GlowCard
              ...
              cardClassName={cn(
                "p-5",
                tier.featured &&
                  "border-primary/25 ring-4 ring-primary/10 group-hover:border-primary/50",
              )}
            >
              {tier.badge ? (
        ...
        {custom ? (
          // Its own RevealGroup: GlowCard's entrance variants only animate
          ...
          <RevealGroup className="mt-4">
            <GlowCard cardClassName="border-dashed border-border/80 bg-card/40 p-6 sm:p-8">
